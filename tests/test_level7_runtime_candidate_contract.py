...
def test_level7_runtime_candidate_is_frozen_and_not_registered(root: Path) -> None:
    ...
    assert contract.entry_point.endswith("write_level_07_fixture_bundle_run")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("status", "experimental_registered_not_default", "status"),
