...
def test_level3_ffd_writes_isolated_orientation_aware_run(root: Path, tmp_path: Path) -> None:
    ...
    result = run_experiment(ExperimentRequest("level_03", "extreme_point_ffd", config_path, 1, 2))
