...
def solver_payload(metadata: dict[str, Any]) -> dict[str, Any]:
    keys = (
        ...
        "repair_early_stop_enabled", "repair_early_stop_minimum_runtime_seconds",
        "repair_early_stop_maximum_no_improvement_candidates",
        "repair_early_stop_triggered", "repair_early_stop_reason",
        ...
        "repair_signal_schema_version", "repair_signal_candidate_count",
        "repair_improvement_events", "repair_first_improvement_seconds",
