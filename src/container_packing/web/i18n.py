...
_TEXT = {
    ...
    "no_benchmarks": {"vi": "Chưa có benchmark nào được lưu cho level này.", "en": "No persisted benchmark exists for this level yet."},
    "persisted_benchmark": {"vi": "Benchmark đã lưu", "en": "Persisted benchmark"},
    "open_benchmark": {"vi": "Mở benchmark đã chọn", "en": "Open selected benchmark"},
    "benchmark_cases": {"vi": "Số case", "en": "Cases"},
    "benchmark_executions": {"vi": "Số lượt chạy", "en": "Executions"},
    "objective_gap": {"vi": "Sai lệch mục tiêu so với mốc (%)", "en": "Objective gap to reference (%)"},
    "runtime_comparison": {"vi": "So sánh thời gian chạy", "en": "Runtime comparison"},
    "quality_comparison": {"vi": "So sánh chất lượng nghiệm", "en": "Solution-quality comparison"},
    "reference_table": {"vi": "Mốc tham chiếu", "en": "Quality references"},
    "ranking_table": {"vi": "Bảng xếp hạng theo từng case", "en": "Per-case ranking"},
