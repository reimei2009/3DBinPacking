...
_TEXT = {
    ...
    "seed": {"vi": "Random seed", "en": "Random seed"},
    "environment": {"vi": "Môi trường thực thi", "en": "Environment metadata"},
    "run": {"vi": "Thử nghiệm", "en": "Run experiment"},
    ...
    "result_tab": {"vi": "Kết quả và mô phỏng", "en": "Result & 3D"},
    "benchmark_tab": {"vi": "So sánh benchmark", "en": "Benchmark comparison"},
    "contract_tab": {"vi": "Mô hình bài toán", "en": "Mathematical model"},
    "history_tab": {"vi": "Lịch sử ", "en": "Run history"},
