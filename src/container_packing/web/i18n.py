...
_TEXT = {
    ...
    "benchmark_run": {"vi": "Lần benchmark đã lưu", "en": "Saved benchmark run"},
    ...
    "item_selection_prefix": {"vi": "Lấy các kiện đầu tiên trong nguồn đang chọn", "en": "First items from the selected source"},
    ...
    "benchmark_valid_algorithms": {"vi": "Thuật toán hợp lệ", "en": "Valid algorithms"},
    "benchmark_best_containers": {"vi": "Số container ít nhất", "en": "Fewest containers"},
    ...
    "benchmark_primary_note": {"vi": "Chất lượng được xét theo thứ tự: nghiệm hợp lệ, ít container hơn, rồi chi phí thấp hơn.", "en": "Quality is ranked by validity, then fewer containers, then lower cost."},
