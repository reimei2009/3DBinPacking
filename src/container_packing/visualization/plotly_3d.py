...
def _wireframe(vertices, *, name: str, color: str = "#222222") -> go.Scatter3d:
    x: list[float | None] = []
    y: list[float | None] = []
    z: list[float | None] = []
    ...
    return go.Scatter3d(
        x=x, y=y, z=z, mode="lines", line={"color": color, "width": 3},
    ...
    for container in containers:
        ...
        for item in container["items"]:
            ...
            figure.add_trace(go.Mesh3d(
                ...
                color=stable_item_color(item["item_id"]), opacity=0.72,
