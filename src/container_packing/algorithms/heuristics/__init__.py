...
from .extreme_point_best_fit import solve_level1 as solve_extreme_point_best_fit
...
from .maximal_space_best_fit import solve_level1 as solve_maximal_space_best_fit
