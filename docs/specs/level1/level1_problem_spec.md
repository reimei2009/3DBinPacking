...
Implemented solution methods are exact MILP Big-M, deterministic Extreme-Point First-Fit Decreasing, objective-aware Extreme-Point Best Fit Decreasing, Extreme-Point Hill Climbing, and seeded Extreme-Point Simulated Annealing. MILP may prove optimality; heuristic and metaheuristic methods only report `FEASIBLE` after independent validation.
